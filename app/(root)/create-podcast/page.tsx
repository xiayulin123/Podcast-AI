          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="mt-12 flex w-full flex-col">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col gap-2.5 ">
                  ...
                  <FormControl>
                    <Input placeholder="shadcn" {...field} className="input-class focus-visible:ring-offset-orange-1"/>
                  </FormControl>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <Select onValueChange={(value) => setVoiceType(value)
                ...
                <SelectContent className="text-16 border-none bg-black-1 font-bold text-white-1 focus:ring-oringe-1">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col gap-2.5 ">
                  <FormLabel className="text-16 font-bold text-white-1">podcastDescription</FormLabel>
                  <FormControl>
